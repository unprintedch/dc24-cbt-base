 ...
 * @return array
 */
function dc24_nav_menu_add_li_class( $classes, $item, $args ) {
...
add_filter( 'nav_menu_css_class', 'dc24_nav_menu_add_li_class', 10, 3 );
 ...
 */
class DC24_Accordion_Menu_Walker extends Walker_Nav_Menu {
