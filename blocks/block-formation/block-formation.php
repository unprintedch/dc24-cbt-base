...
?>
    ...
    <div class="p-6 pt-0 grid gap-6">
        ...
        ?>
            <a href="<?php echo get_permalink(1103) ?>?postid=<?php echo $post_id ?>&sessionid=<?php echo  $unique_id ?>" class="<?php echo  $info_place_slug . " " . $classes_available ?> course-item p-6 bg-gray-200 grid grid-cols-2 text-base rounded-lg shadow-md">
